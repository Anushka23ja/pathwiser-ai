...
const schoolDatabase: SchoolEntry[] = [
  ...
  { id: "s21", name: "UCLA", type: "University", location: "Los Angeles, CA", state: "CA", acceptanceRate: 0.09, avgTuition: "$13,804/yr (in-state)", tuitionBucket: "moderate", topPrograms: ["Film", "Psychology", "Biology", "Political Science", "Engineering"], strongMajors: ["Biology", "Psychology", "Design", "Engineering", "Communications"], avgGpaAdmitted: 3.93, avgSatAdmitted: 1510, website: "ucla.edu", description: "Top public university with world-class arts, sciences, and pre-med programs in LA." },
  { id: "s22", name: "Duke University", type: "University", location: "Durham, NC", state: "NC", acceptanceRate: 0.06, avgTuition: "$62,000/yr", tuitionBucket: "high", topPrograms: ["Pre-Med", "Public Policy", "Computer Science", "Economics"], strongMajors: ["Biology", "Computer Science", "Economics", "Law", "Medicine"], avgGpaAdmitted: 3.95, avgSatAdmitted: 1540, website: "duke.edu", description: "Elite research university with exceptional pre-med and public policy programs." },
  { id: "s23", name: "University of Wisconsin-Madison", type: "University", location: "Madison, WI", state: "WI", acceptanceRate: 0.49, avgTuition: "$10,796/yr (in-state)", tuitionBucket: "low", topPrograms: ["Engineering", "Business", "Biology", "Computer Science"], strongMajors: ["Engineering", "Business", "Biology", "Computer Science", "Education"], avgGpaAdmitted: 3.75, avgSatAdmitted: 1380, website: "wisc.edu", description: "Top-tier public research university with strong STEM and business programs." },
  { id: "s24", name: "NYU (New York University)", type: "University", location: "New York, NY", state: "NY", acceptanceRate: 0.13, avgTuition: "$58,168/yr", tuitionBucket: "high", topPrograms: ["Business (Stern)", "Film (Tisch)", "Law", "Data Science"], strongMajors: ["Business", "Finance", "Design", "Communications", "Law"], avgGpaAdmitted: 3.85, avgSatAdmitted: 1480, website: "nyu.edu", description: "Premier urban university in NYC with world-class business, arts, and data science." },
  { id: "s25", name: "University of Florida", type: "University", location: "Gainesville, FL", state: "FL", acceptanceRate: 0.23, avgTuition: "$6,380/yr (in-state)", tuitionBucket: "low", topPrograms: ["Engineering", "Business", "Biology", "Agriculture"], strongMajors: ["Engineering", "Business", "Biology", "Computer Science"], avgGpaAdmitted: 3.8, avgSatAdmitted: 1400, website: "ufl.edu", description: "Top 5 public university with exceptional value and strong research funding." },
  { id: "s26", name: "Rice University", type: "University", location: "Houston, TX", state: "TX", acceptanceRate: 0.09, avgTuition: "$54,960/yr", tuitionBucket: "high", topPrograms: ["Engineering", "Architecture", "Computer Science", "Business"], strongMajors: ["Engineering", "Computer Science", "Architecture", "Biology"], avgGpaAdmitted: 3.92, avgSatAdmitted: 1530, website: "rice.edu", description: "Small, elite research university with incredible student-to-faculty ratio and Houston energy sector access." },
  { id: "s27", name: "University of North Carolina at Chapel Hill", type: "University", location: "Chapel Hill, NC", state: "NC", acceptanceRate: 0.17, avgTuition: "$8,998/yr (in-state)", tuitionBucket: "low", topPrograms: ["Business", "Journalism", "Public Health", "Biology"], strongMajors: ["Business", "Biology", "Communications", "Nursing", "Education"], avgGpaAdmitted: 3.85, avgSatAdmitted: 1430, website: "unc.edu", description: "Top public university with outstanding business school and public health programs." },
  { id: "s28", name: "Northeastern University", type: "University", location: "Boston, MA", state: "MA", acceptanceRate: 0.07, avgTuition: "$58,000/yr", tuitionBucket: "high", topPrograms: ["Computer Science", "Engineering", "Business", "Health Sciences"], strongMajors: ["Computer Science", "Engineering", "Business", "Nursing"], avgGpaAdmitted: 3.88, avgSatAdmitted: 1490, website: "northeastern.edu", description: "Pioneer of co-op education — students alternate between study and 6-month paid work experiences." },
  { id: "s29", name: "Arizona State University", type: "University", location: "Tempe, AZ", state: "AZ", acceptanceRate: 0.88, avgTuition: "$11,338/yr (in-state)", tuitionBucket: "low", topPrograms: ["Engineering", "Business", "Education", "Sustainability"], strongMajors: ["Engineering", "Business", "Computer Science", "Education", "Design"], avgGpaAdmitted: 3.3, avgSatAdmitted: 1200, website: "asu.edu", description: "#1 in innovation (ahead of MIT & Stanford). Massive program variety with excellent online options." },
  { id: "s30", name: "Portland Community College", type: "Community College", location: "Portland, OR", state: "OR", acceptanceRate: 0.99, avgTuition: "$4,500/yr", tuitionBucket: "low", topPrograms: ["Nursing", "CS Transfer", "Dental Hygiene", "Welding"], strongMajors: ["Nursing", "Computer Science", "Engineering", "Business"], avgGpaAdmitted: 2.0, avgSatAdmitted: 0, website: "pcc.edu", description: "Oregon's largest community college with strong health and tech transfer programs." },
  { id: "s31", name: "Northwestern University", type: "University", location: "Evanston, IL", state: "IL", acceptanceRate: 0.07, avgTuition: "$60,768/yr", tuitionBucket: "high", topPrograms: ["Journalism (Medill)", "Engineering", "Business (Kellogg)", "Theater"], strongMajors: ["Communications", "Engineering", "Business", "Design", "Education"], avgGpaAdmitted: 3.94, avgSatAdmitted: 1530, website: "northwestern.edu", description: "Elite private university with the nation's top journalism school and strong engineering." },
  { id: "s32", name: "University of Colorado Boulder", type: "University", location: "Boulder, CO", state: "CO", acceptanceRate: 0.80, avgTuition: "$12,500/yr (in-state)", tuitionBucket: "low", topPrograms: ["Aerospace", "Physics", "Environmental Science", "Computer Science"], strongMajors: ["Engineering", "Physics", "Computer Science", "Environmental Science"], avgGpaAdmitted: 3.55, avgSatAdmitted: 1280, website: "colorado.edu", description: "Top aerospace and environmental programs with stunning mountain campus and startup culture." },
  { id: "s33", name: "Howard University", type: "University", location: "Washington, DC", state: "DC", acceptanceRate: 0.30, avgTuition: "$28,870/yr", tuitionBucket: "moderate", topPrograms: ["Business", "Communications", "Biology", "Political Science"], strongMajors: ["Business", "Biology", "Communications", "Law", "Education"], avgGpaAdmitted: 3.5, avgSatAdmitted: 1250, website: "howard.edu", description: "Premier HBCU producing leaders in business, medicine, law, and STEM. Powerful alumni network." },
  { id: "s34", name: "Emory University", type: "University", location: "Atlanta, GA", state: "GA", acceptanceRate: 0.11, avgTuition: "$57,948/yr", tuitionBucket: "high", topPrograms: ["Pre-Med", "Business", "Nursing", "Public Health"], strongMajors: ["Biology", "Business", "Nursing", "Psychology", "Medicine"], avgGpaAdmitted: 3.9, avgSatAdmitted: 1500, website: "emory.edu", description: "Top pre-med and business university co-located with CDC. Outstanding healthcare research." },
  { id: "s35", name: "Santa Monica College", type: "Community College", location: "Santa Monica, CA", state: "CA", acceptanceRate: 0.99, avgTuition: "$3,200/yr", tuitionBucket: "low", topPrograms: ["Film", "Business Transfer", "CS Transfer", "Nursing"], strongMajors: ["Business", "Computer Science", "Design", "Communications"], avgGpaAdmitted: 2.0, avgSatAdmitted: 0, website: "smc.edu", description: "#1 transfer feeder to UCLA. Exceptional liberal arts and creative programs in Los Angeles." },
];
